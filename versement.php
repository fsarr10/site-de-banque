        ...
        <div class='collapse navbar-collapse' id='navbarNav'>
            <ul class='navbar-nav ml-auto container justify-content-end'>
                <li class='nav-item active'>
                    <a href="admin.php"><button class='btn btn-dark rounded-pill' type='submit'>Accueil</button></a>
                </li>
                <li class='nav-item active'>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($update_result === TRUE) {
            ...
            echo "<div style='text-align: center; margin-top: 50px;'>Erreur lors du versement.</div>";
        }
    } else {
