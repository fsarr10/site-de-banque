...
<nav class='navbar navbar-expand-lg navbar-dark bg-success'>
    <div class='container'>
        <a class="navbar-brand fw-bold" href="">Payement</a>
        ...
        <div class='collapse navbar-collapse' id='navbarNav'>
            <ul class='navbar-nav ml-auto container justify-content-end'>
                <li class='nav-item active'>
                    <a href="client.php"><button class='btn btn-dark rounded-pill' type='submit'>Accueil</button></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center"><strong>Payement</strong></h3>
                </div>
                <div class="card-body">
                   <form method="POST" action="">
                          <div class="form-group">
                            <div class="container">
                                <div class="row mb-2">
                                    <div class="col-md-5">
                                        <label class="form-label">Que voulez vous payer ?</label>
                                    </div>
                                    <div class="col-md-6">
                                        <input class="form-control required" type="text" placeholder="Payement" name="prenom" required>
                                    </div>
                                </div>
                            </div>
                        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($update_result === TRUE) {
            echo "<div style='text-align: center; margin-top: 50px;'>Payement de $prenom effectué avec succès.</div>";
        } else {
            echo "<div style='text-align: center; margin-top: 50px;'>Erreur lors du payement.</div>";
        }
    } else {
