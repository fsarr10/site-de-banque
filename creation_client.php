        ...
        <div class='collapse navbar-collapse' id='navbarNav'>
            <ul class='navbar-nav ml-auto container justify-content-end'>
                <li class='nav-item active'>
                    <a href="index.php"><button class='btn btn-dark rounded-pill' type='submit'>Accueil</button></a>
                </li>
            </ul>
        </div>
    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($insert_result === TRUE) {
            ...
            echo '<p>Redirection vers la <a href="lister.php">liste des comptes</a>...</p>';
...
<div class="container mt-5">
  <form method="POST" action="creation_client.php">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center"><strong>Inscription</strong></h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="cgu">J'accepte les conditions générales d'utilisation et de sécurité</label>
