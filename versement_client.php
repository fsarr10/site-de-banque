...
<nav class='navbar navbar-expand-lg navbar-dark bg-success'>
    <div class='container'>
        <a class="navbar-brand fw-bold" href="">Versement</a>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center"><strong>Versement</strong></h3>
                </div>
                <div class="card-body">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        ...
        if ($update_result === TRUE) {
            echo "<div style='text-align: center; margin-top: 50px;>Versement effectué avec succès.</div>";
        } else {
            echo "<div style='text-align: center; margin-top: 50px;>Erreur lors de la mise à jour du solde.</div>";
        }
    } else {
